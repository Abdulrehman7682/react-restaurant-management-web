    ...
    return (
        <div className="container my-4">
            ...
            {cartItems.length === 0 ? (
                ...
                cartItems.map((item) => (
                    <div className="card py-3 px-3 mb-3" key={item.id} style={{ position: 'relative', boxShadow: "rgba(0, 0, 0, 0.35) 0px 5px 15px" }}>
                        <div className='d-flex'>
                            <div>
                                <Image src={item.url} alt={item.title} style={{ height: 120, width: 120 }} />
                            </div>
                            <div className='mx-3'>
                                <h5>{item.title}</h5>
                                <p className='mb-0'>{item.category}</p>
                                <p className='mb-0'>{item.description}</p>
                                <p className='mb-0'>${item.price} * {item.quantity || 1}</p>
                            </div>
                        </div>
