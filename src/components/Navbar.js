...
export default function Navbar() {
    ...
    return (
        <nav className="navbar navbar-expand-lg bg-light navbar-light" style={{ boxShadow: "1px 1px 10px black" }}>
            <div className="container">
                <Link to="/" className="navbar-brand" style={{ color: "grey", fontSize: 23, fontWeight: 'bold' }}>AR Restaurant</Link>
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav m-auto mb-2 mb-lg-0">
                        ...
                        <li className="nav-item"><Link to="/about" className="nav-link active mx-2">About</Link></li>
                        <li className="nav-item"><Link to="/contact" className="nav-link active mx-2">Contact</Link></li>
                        <li className="nav-item">{admin && admin.email === "admin@gmail.com" ? <Link to="/admin" className="nav-link active mx-2">Admin</Link> : null}</li>
                        <li className="nav-item">{isAuthenticated ? <Link to="/menuItems" className="nav-link active mx-2">Menu Items</Link> : null}</li>
